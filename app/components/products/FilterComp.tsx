        ...
        <div className="w-[80%]">
            ...
            <form onSubmit={() => handleSubmit(onSubmit)} className="w-full grid grid-cols-4 gap-3">
                ...
                <div className="flex items-center justify-between gap-3 px-1 py-0.5 rounded w-full bg-gray-100 border">
                    <input type="number" className="border rounded py-0.5 px-3 robo w-[45%] border-black/30" placeholder="Min-Price"/>
                    <p className="font-semibold text-2xl">-</p>
                    <input type="number" className="border rounded py-0.5 px-3 robo w-[45%] border-black/30" placeholder="Max-Price"/>
                </div>
                ...
                <div className="w-full grid grid-cols-6 gap-2">
                    ...
                    <button type="reset" className="btn robo w-full h-full border border-[#9ed11c] font-semibold hover:text-[#6d920e] bg-[#9ed11c] hover:bg-transparent hover:border-[#9ed11c]"><GrPowerReset /></button>
