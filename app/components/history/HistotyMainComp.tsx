...
"use client";
import { useGetMyHistoryQuery } from "@/app/redux/features/orders/ordersApi";
import { TOrder } from "@/app/types/order";
import Link from "next/link";

const HistotyMainComp = () => {

    const { data } = useGetMyHistoryQuery(undefined) ;
...
export default HistotyMainComp;
